package kr.or.ddit.riturn.vo;

public class RiturnVO {
	...
	public int getDcart_qty() {
		return dcart_qty;
	}
	public void setDcart_qty(int dcart_qty) {
	...
	public String toString() {
		return "Riturn [pay_id=" + pay_id + ", re_id=" + re_id + ", re_qty=" + re_qty + ", re_date=" + re_date
				+ ", re_reason=" + re_reason + "]";
	}
