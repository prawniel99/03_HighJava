...
public class ReviewServiceImpl implements IReviewService {
    ...
    @Override
    public boolean isReviewExistForCart(String prodId, String memId) {
        // DAO에서 중복 체크 메서드를 호출
        return dao.isReviewExistForCart(prodId, memId) > 0;
    }
	...
	public List<ReviewVO> reviewProd(String prodId) {
		// TODO Auto-generated method stub
		return dao.reviewProd(prodId);
	}

	@Override
	public List<ReviewVO> prodReview(ReviewVO reviewVo) {
		// TODO Auto-generated method stub
		return dao.prodReview(reviewVo);
	}
}
