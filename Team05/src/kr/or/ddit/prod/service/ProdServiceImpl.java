...
public class ProdServiceImpl implements IProdService {
	...
	public PageVO getNewArrPagination(int page, String stype, String sword) {
		...
		// 전체 레코드 수 가져오기
		int totalCount = dao.getNewArrCount(map);
	...
	@Override
	public PageVO getBestPagination(int page, String stype, String sword) {
		// Map 생성 방식 수정
		Map<String, Object> map = new HashMap<>();
		map.put("stype", stype);
		map.put("sword", sword);
		...
		// 전체 레코드 수 가져오기
		int totalCount = dao.getBestCount(map);
		System.out.println("totalCount= " + totalCount);
	...
	@Override
	public PageVO getOuterPagination(int page, String stype, String sword) {
		// Map 생성 방식 수정
		Map<String, Object> map = new HashMap<>();
		map.put("stype", stype);
		map.put("sword", sword);
		...
		// 전체 레코드 수 가져오기
		int totalCount = dao.getOuterCount(map);
		System.out.println("totalCount= " + totalCount);
	...
	@Override
	public PageVO getTopPagination(int page, String stype, String sword) {
		// Map 생성 방식 수정
		Map<String, Object> map = new HashMap<>();
		map.put("stype", stype);
		map.put("sword", sword);
		...
		// 전체 레코드 수 가져오기
		int totalCount = dao.getTopCount(map);
		System.out.println("totalCount= " + totalCount);
	...
	@Override
	public PageVO getBottomPagination(int page, String stype, String sword) {
		// Map 생성 방식 수정
		Map<String, Object> map = new HashMap<>();
		map.put("stype", stype);
		map.put("sword", sword);
		...
		// 전체 레코드 수 가져오기
		int totalCount = dao.getBottomCount(map);
		System.out.println("totalCount= " + totalCount);
	...
	@Override
	public PageVO getAccPagination(int page, String stype, String sword) {
		// Map 생성 방식 수정
		Map<String, Object> map = new HashMap<>();
		map.put("stype", stype);
		map.put("sword", sword);
		...
		// 전체 레코드 수 가져오기
		int totalCount = dao.getAccCount(map);
		System.out.println("totalCount= " + totalCount);
