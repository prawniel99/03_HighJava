...
<!------- qna 글쓰기 modal --------->
<div class="modal" id="qnaInsertModal">
				...
				<form name="wfrom" id="wform">
					...
					<div id="qnaProdPic-container">
						...
						<div id="qnaProdPic-container-body">
							<img src="cat-jump.png" id="qnaProdPic" class="qnaInsertPic"> <br>
						</div>
					</div>
					...
					<label>암호</label>
					<input type="password"  class="txt" id="password"   name="password"> <br><br>
