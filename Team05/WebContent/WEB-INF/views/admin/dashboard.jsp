...
<body>
    <div class="container">
        ...
        <button class="menu-button" onclick="location.href='<%=request.getContextPath()%>/member/memberList.do'">회원 관리</button>
        <button class="menu-button" onclick="location.href='<%=request.getContextPath()%>/member/adminDashboard.do'">대시보드</button>
        <!-- 하민 -->
        <button class="menu-button" onclick="location.href='<%=request.getContextPath()%>/main?view=index'">index</button>
        <!-- 하민 -->
        ...
        <div class="card-grid">
            ...
            <div class="card">
                <h2><a href="<%=request.getContextPath()%>/reviewList.do">리뷰 관리</a></h2>
                <p>리뷰를 관리합니다.</p>
            </div>
            <div class="card">
