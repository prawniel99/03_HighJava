...
<%
    ...
    if (id != null) {
		...
		// out.println("<a href='"+request.getContextPath()+"/seLogout.do' onclick='logout'>로그아웃</a>");
		out.println("<a href='"+request.getContextPath()+"/basic/session/sessionExercise.jsp' onclick='logout'>로그아웃</a>");
%>
